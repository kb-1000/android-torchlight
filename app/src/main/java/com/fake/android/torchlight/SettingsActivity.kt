...
class SettingsActivity : AppCompatPreferenceActivity() {
    ...
    override fun isValidFragment(fragmentName: String): Boolean {
        return PreferenceFragment::class.java.name == fragmentName || InformationPreferenceFragment::class.java.name == fragmentName
    }

    /**
     * This fragment shows information about app only. It is used when the
    ...
    companion object {
        ...
        private val sBindPreferenceSummaryToValueListener = Preference.OnPreferenceChangeListener { preference, value ->
            ...
            when {
                ...
                preference.key == "app_version" -> preference.summary = BuildConfig.VERSION_NAME
